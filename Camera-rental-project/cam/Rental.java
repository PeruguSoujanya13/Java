package cam;
	...
	public class Rental {
			...
			public static void main(String[] args) {
				...
				cameraList.add(new camera(3, "Panasonic", "XC", 500.0,    "Rented"));
				...
				cameraList.add(new camera(12, "canon",     "digital", 123.0,   "Available"));
				cameraList.add(new camera(13, "nikon",     "DSLR-D7500", 500.0,   "Available"));
				cameraList.add(new camera(14, "Something",   "some", 200.0,   "Available"));
				cameraList.add(new camera(15, "Some",      "Another", 100.0,  "Available"));
				cameraList.add(new camera(16, "Canon",     "Digital", 123.0,   "Available"));
				cameraList.add(new camera(17, "NIKON",      "DSLR-D7500", 25500.0,"Available"));
				cameraList.add(new camera(18, "Sony",       "DSLR12", 200.0,     "Available"));
				cameraList.add(new camera(19, "Samsung",     "SM123", 200.0,     "Available"));
				cameraList.add(new camera(20, "Sony",        "SONY1234", 123.0,  "Available"));
				users.add(new user("Souji", "souji1329", 10000));

				System.out.println("+-------------------------------------------+");
				System.out.println("|        WELCOME TO CAMERA RENTAL      |");
				System.out.println("+-------------------------------------------+");
